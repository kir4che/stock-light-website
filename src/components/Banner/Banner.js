...
export default function Banner() {
	return (
		<div className="w-full h-56 lg:h-80 bg-[url('https://imgur.com/TUd42OT.jpg')] dark:bg-[url('https://imgur.com/bLhruDF.jpg')] bg-no-repeat bg-cover bg-center">
			<Temple />
		</div>
	)
}
...
function Temple() {
	return (
		<svg
			className='w-[280px] h-[240px] lg:w-[400px] lg:h-[340px]'
		...
		>
			...
			<g className={style.window}>
				...
				<line className='window_red' x1='31.5' y1='181.501' x2='71.5' y2='181.501' />
				<line className='window_red' x1='231.5' y1='181.501' x2='271.5' y2='181.501' />
				<line className='window_red' x1='31.5' y1='141.501' x2='71.5' y2='141.501' />
				<line className='window_red' x1='231.5' y1='141.501' x2='271.5' y2='141.501' />
			</g>
