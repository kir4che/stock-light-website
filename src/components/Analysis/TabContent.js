			...
			return (
				<>
					...
					<section className='flex flex-col-reverse items-start gap-2 xs:gap-6 md:flex-row'>
						...
						/>
						<section className='grid grid-row-3 w-full mt-3 space-y-2 xs:items-center xs:space-y-4 xs:space-x-0 xs:flex-row md:items-stretch md:mt-0 md:space-x-0 md:space-y-2 md:mb-2 md:w-48 md:flex-col'>
