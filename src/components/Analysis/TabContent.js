					...
					{(() => {
						switch (subchart) {
							case 'MACD':
								return (
									<Chart
										option={macdOption(date, closePrice, techAnalDataZoomRange, handleTechAnalDataZoomChange)}
							...
							case 'RSI':
								return (
									<Chart
										option={rsiOption(date, change, techAnalDataZoomRange, handleTechAnalDataZoomChange)}
										customHeight='h-56 md:h-64 xl:h-[320px]'
									/>
								)
							case 'William':
								return (
									<Chart
										option={williamOption(date, closePrice, techAnalDataZoomRange, handleTechAnalDataZoomChange)}
										customHeight='h-56 md:h-64 xl:h-[320px]'
									/>
								)
							case '乖離率':
								return (
									<Chart
										option={biasOption(date, closePrice, techAnalDataZoomRange, handleTechAnalDataZoomChange)}
										customHeight='h-56 md:h-64 xl:h-[320px]'
									/>
								)
							case 'ADL':
