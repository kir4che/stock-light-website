	...
	return (
		<div className='h-screen'>
			...
			<div className='relative z-0 pt-10 pb-6 text-center'>
				<h1 className='mb-4 leading-tight text-transparent drop-shadow-md text-8xl bg-clip-text bg-gradient-to-tl from-indigo-400 from-10% via-amber-100 dark:via-sky-100 via-20% to-amber-300 dark:to-primary_yellow to-60% dark:to-80%'>
					股市光明燈
				</h1>
				<p className='font-light'>帶給所有投資人新的希望</p>
				<div className='space-x-5 mt-7 flex-center'>
					<button
					...
					<button className='px-5 py-2 text-sm tracking-wide rounded-full bg-primary_yellow text-zinc-800 hover:bg-amber-300'>
						<a href='https://www.youtube.com/watch?v=bPptTi9uR-0' target='_blank'>
							概念影片
						</a>
					</button>
				</div>
				...
				>
					<h1 className='font-black text-transparent leading-tight text-9xl bg-clip-text bg-gradient-to-b from-primary_yellow to-amber-100/80 filter blur-[2px]'>
						Light a Lantern for stock market.
					</h1>
				</div>
			</div>
			<div className="h-56 border-b-2 dark:border-zinc-900 lg:h-80 bg-[url('https://imgur.com/TUd42OT.jpg')] dark:bg-[url('https://imgur.com/eUbTc8f.jpg')] bg-no-repeat lg:bg-cover bg-center">
				<svg
