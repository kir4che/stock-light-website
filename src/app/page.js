      ...
      <div className="grid grid-flow-col grid-rows-3 mt-12 mb-20 lg:gap-20">
        ...
        <div className="col-span-12">
          <div className="mb-8">
            ...
            <img src="../images/TAIEX.png" alt="TAIEX" />
          </div>
          <div className="flex items-center">
            <img className="w-12" src="../images/good-quality-64.png" alt="recommend" />
            <h4 className="pl-1 pr-6 font-bold">本日預測股票</h4>
            <button className="light-btn font-medium cursor-pointer px-12 py-1.5 bg-primary_yellow" type="button" onClick={() => router.push('/light')}>
              我要點燈！
            </button>
          </div>
        </div>
